# DEMO WIDGET USABILITY STUDY SWEEPSTAKES — OFFICIAL RULES

## 1. SPONSOR

These Official Rules (“Rules”) govern the operation of the DEMO WIDGET USABILITY STUDY Sweepstakes (“Sweepstakes”). Microsoft Corporation, One Microsoft Way, Redmond, WA, 98052, USA, is the Sweepstakes sponsor (“Sponsor”).
...
You will receive one entry by visiting the web site for the Sweepstakes at https://www.research.net/r/DEMO2026 and completing all of the registration requirements including completion of a short survey. All required survey questions must be answered to receive an entry.
...
Pending confirmation of eligibility, one (1) potential prize winner(s) will be selected by Microsoft or their Agent in a random drawing from among all eligible entries received within 7 days following the Entry Period.
...
One (1) Grand Prize. A Gift card of your choosing from BHN.com. Approximate Retail Value (ARV) $200.00 USD.

The total Approximate Retail Value (ARV) of all prizes: $200.00
...
Send an email to researcher@github.com with the subject line “Demo Widget Usability Study Sweepstakes Winners” within 30 days of August 31, 2026 to receive a list of winners.
