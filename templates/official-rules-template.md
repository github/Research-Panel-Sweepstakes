<!--
CANONICAL SWEEPSTAKES OFFICIAL RULES TEMPLATE
=============================================
This is the CELA-approved, pre-cleared template. If you fill in ONLY the {{PLACEHOLDER}}
fields below and leave every other word unchanged, the agent review gate will PASS your
document automatically and NO fresh CELA review is required.

Changing, removing, or reordering any of the non-placeholder legal language (Sections 1, 2,
5 boilerplate, 6, 7 boilerplate, 8, 9, 10, 11, the employee-exclusion and "Void in ..."
sentences, or the "No Purchase Necessary" declaration) will FLAG the document for CELA review.

Allowed per-study fields: {{TITLE}}, {{ENTRY_PERIOD_START}}, {{ENTRY_PERIOD_END}},
{{ELIGIBILITY_AUDIENCE}}, {{SURVEY_URL}}, {{ENTRY_LIMIT}}, {{PRIZE_DESCRIPTION}}, {{ARV}},
{{NUM_WINNERS}}, {{WINNERS_LIST_EMAIL}}, {{WINNERS_LIST_SUBJECT}}, {{WINNERS_LIST_WINDOW}}.

Export to PDF and upload to this repository, then link it from your survey/email.
-->
...
These Official Rules (“Rules”) govern the operation of the {{TITLE}} Sweepstakes (“Sweepstakes”). Microsoft Corporation, One Microsoft Way, Redmond, WA, 98052, USA, is the Sweepstakes sponsor (“Sponsor”).
...
The Sweepstakes starts at 12:00 a.m. Pacific Time (PT) on {{ENTRY_PERIOD_START}}, and ends at 11:59 p.m. PT on {{ENTRY_PERIOD_END}} (“Entry Period”).

## 4. ELIGIBILITY

This is a closed Sweepstakes open only to recipients who received a survey invitation. To enter, you must be 18 years of age or older and {{ELIGIBILITY_AUDIENCE}}. If you are 18 years of age or older but have not reached the age of majority in your legal place of residence, then you must have consent of a parent/legal guardian.
...
You will receive one entry by visiting the web site for the Sweepstakes at {{SURVEY_URL}} and completing all of the registration requirements including completion of a short survey. All required survey questions must be answered to receive an entry.

The entry limit is {{ENTRY_LIMIT}} per person overall.

Any attempt by you to obtain more than the stated number of entries by using multiple/different accounts, identities, registrations, logins, or any other methods will void your entries and you may be disqualified. Use of any automated system to participate is prohibited. We are not responsible for lost, late, or incomplete entries. If disputed, entries will be deemed submitted by the “authorized account holder” of the email address, social media account, or other method used to enter. The “authorized account holder” is the natural person assigned to an email address by an internet or online service provider, or other organization responsible for assigning email addresses.

## 6. WINNER SELECTION AND NOTIFICATION

Pending confirmation of eligibility, {{NUM_WINNERS}} potential prize winner(s) will be selected by Microsoft or their Agent in a random drawing from among all eligible entries received within 7 days following the Entry Period.
...
{{PRIZE_DESCRIPTION}}. Approximate Retail Value (ARV) {{ARV}} USD.

The total Approximate Retail Value (ARV) of all prizes: {{ARV}}
...
Send an email to {{WINNERS_LIST_EMAIL}} with the subject line “{{WINNERS_LIST_SUBJECT}}” within 30 days of {{WINNERS_LIST_WINDOW}} to receive a list of winners.
